...
<div class="topnav">    
    ...
    <a href="kontrolnatablaoglas.php" class="active">Огласи</a>
    <a href="kontrolnatabla.php" >Корисници</a>
</div>



<div>
    <h1>Преглед Огласа</h1>
    ...
    <form action="/action_page.php" class="formaUnosOglasa">
        ...
        <input type="submit" value="Одобри">
    </form>
</div>
