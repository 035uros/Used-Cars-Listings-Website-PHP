...
if(isset($_POST["unosvozila"])){
    ...
    if(in_array($fileActualExt, $allowed)){
        if($fileError === 0){
            ...
            $fileDestination = 'C:/Users/Uroš/Desktop/www/UsedCarsApp/images/'.$fileNameNew;
...
$conn->query("SET NAMES 'utf8'");
    ...
    $sql = "INSERT INTO `oglas` (`broj_oglasa`, `naslov`, `id_korisnika`, `vin_automobila`, `cena`,`status_oglasa`, `datum`,`cena_fix`,`zamena`) VALUES ($broj_oglasa, '$naslov', $id_korisnika, $vin, $cena, 1, '$datum', $fiks, $zamena)";
